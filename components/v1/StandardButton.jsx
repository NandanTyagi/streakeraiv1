...
const StandardButton = ({
  ...
  const AiDentifySvg = (
    ...
    >
      <circle cx="30" cy="30" r="24" stroke="currentColor" strokeWidth="2" />
      <circle cx="30.225" cy="29.2262" r="9.08333" stroke="currentColor" />
      <path d="M30.4989 18V22.9286" stroke="currentColor" strokeLinecap="round" />
      <path d="M30.4989 36.0714V41" stroke="currentColor" strokeLinecap="round" />
      <path
        d="M36.8876 29.5L41.9973 29.6012"
        stroke="currentColor"
        strokeLinecap="round"
      />
      <path d="M19 29.3988L24.1098 29.5" stroke="currentColor" strokeLinecap="round" />
      <circle cx="30.4989" cy="29.5" r="1.09524" fill="currentColor" />
    </svg>
  );
  ...
  const joinSvg = (
    ...
    >
      ...
      <line
        ...
        strokeLinecap="round"
      />
      <circle cx="24.5" cy="24.5" r="3.5" fill="currentColor" />
      <path
