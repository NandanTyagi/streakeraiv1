...
const Hero = () => {
  return (
    <div className="relative h-[100%] max-h-[calc(100svh-10px)] flex justify-center items-center w-screen">
    <div className="absolute z-[10] h-[calc(100svh-40px)]  inset-0 bg-black opacity-70 overflow-hidden"></div>
