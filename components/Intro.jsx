...
const Intro = () => {
  ...
  return (
    <div className="relative h-[100%] overflow-hidden" ref={comp}>
      <div
        className="h-[100%] bg-white justify-center place-items-center absolute inset-0 w-full flex flex-col z-10"
        id="intro-slider"
      >
        <div>
          <h1
            className={`font-bold text-5xl sm:text-8xl mb-2 opacity-0`}
            id="identify"
          >
            Identify
          </h1>
          ...
          <h1
            className={`font-bold text-5xl sm:text-8xl opacity-0`}
            id="achieve"
          >
            Achieve
          </h1>
      ...
      <div className="flex flex-col justify-center bg-black place-items-center h-[100%] ">
          <h1
            className={`font-bold  text-5xl sm:text-9xl text-white opacity-[1] mb-4 sm:mb-20`}
            id="streaker"
          >
            Streaker.ai
          </h1>
